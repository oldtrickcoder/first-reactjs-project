    ...
    return (
     <Section>
         <Container>
            ...
            whileTap={{scale: 0.9}}
            drag={true}
            dragConstraints={{left:0,right:256,top:0,bottom:50}}
            ...
            whileTap={{scale: 0.9}}
            drag={true}
            dragConstraints={{left:50,right:256,top:150,bottom:50}}
            ...
            whileTap={{scale: 0.9}}
            drag={true}
            dragConstraints={{left:30,right:256,top:20,bottom:50}}
            initial={{opacity:0, y:-100}}
            animate={{opacity:1,y:0,transition:{duration:1}}}
            />
            ...
            whileTap={{scale: 0.9}}
            drag={true}
            dragConstraints={{left:80,right:256,top:100,bottom:50}}
            initial={{opacity:0, y:-100}}
            animate={{opacity:1,y:0,transition:{duration:1}}}
            />
            </ColumnRight> 
